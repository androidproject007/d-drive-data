...
public class chapterAllMaterialAdapter extends RecyclerView.Adapter<chapterAllMaterialAdapter.ViewHolder> {
    Activity activity;
    ...
    public chapterAllMaterialAdapter(Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teachers_row_matiral, parent, false);
