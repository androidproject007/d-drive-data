...
public class AttandenceAdapter extends RecyclerView.Adapter<AttandenceAdapter.ViewHolder> {
...
//    protected List<BidoffersellerList> origList;
    ...
    public AttandenceAdapter(Activity context, List<AttandenceList> attandenceLists){
...
//        this.origList = bidoffersellerLists;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      View view= mInflater.inflate(R.layout.student_row_attandence,parent,false);
