...
public class TimetableDateAdapter extends RecyclerView.Adapter<TimetableDateAdapter.ViewHolder> {
    ...
    Dialog dialog;
    List<DayList> dayListitem;


    public TimetableDateAdapter(Activity context,List<DayList>dayLists){
        this.context=context;
        this.dayListitem = dayLists;
//        this.origList = bidoffersellerLists;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      View view= mInflater.inflate(R.layout.student_row_date_timetable,parent,false);
       return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, final  int position){
        DayList item= dayListitem.get(position);
